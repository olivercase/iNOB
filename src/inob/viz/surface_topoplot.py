...
def render_surface_topoplots(
    ...
    *,
    ...
    sm_meg = plt.cm.ScalarMappable(cmap=cmap, norm=plt.Normalize(vmin=vmin_meg, vmax=vmax_meg))
    ...
    _draw_eeg_2d_topoplot(ax_e, electrodes, eeg_val, cfg, vmin=vmin_eeg, vmax=vmax_eeg)
