...
see `inob --help` for the full list.""",
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="Cervical paddle electrode positions (default: this target's outputs.electrodes_mat).",
    )
    p.add_argument(
        "--paddle-npz",
        type=Path,
        default=None,
        help="Paddle EEG leadfield NPZ (default: this target's outputs.forward_eeg_npz).",
    )
    p.add_argument(
        "--wholebody-mat",
        type=Path,
    ...
    render_location_optimisation(
        cfg,
        paddle_mat=paddle_mat,
        paddle_npz=paddle_npz,
        wholebody_mat=args.wholebody_mat,
        wholebody_npz=wholebody_npz,
