...
see `inob --help` for the full list.""",
    ...
    add_common_args(p)
    p.add_argument("--rows", type=int, default=None, help="Override electrodes.rows.")
    p.add_argument("--cols", type=int, default=None, help="Override electrodes.cols.")
    p.add_argument(
        "--pitch",
        type=float,
        default=None,
        dest="contact_pitch_mm",
