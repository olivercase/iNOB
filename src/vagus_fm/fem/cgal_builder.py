...
from vagus_fm.io.hdf5 import FemMesh, save_fem, validate_fem
from vagus_fm.io.stl import load_stl, load_stl_glob
...
def _load_tissue_surfaces(cfg: Config):
    ...
    Friendly errors (via :class:`vagus_fm.io.stl.STLLoadError`) replace the
    ...
    if not bone_paths:
        from vagus_fm.io.stl import STLLoadError
