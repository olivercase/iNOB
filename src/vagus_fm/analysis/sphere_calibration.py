...
Used to fix the ambiguity around the EEG ×factor in :mod:`vagus_fm.forward.eeg`
...
from vagus_fm.analysis.analytic_sphere import homogeneous_sphere_eeg_potential
from vagus_fm.io.hdf5 import FemMesh, SensorArray, save_fem, save_sensors
...
def build_sphere_fem(
    ...
    *,
    ...
    Identical pipeline to ``vagus_fm.fem.cgal_builder`` so DUNEuro sees a
