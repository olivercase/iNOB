...
:mod:`vagus_fm.forward.solve` (the legacy ``cluster/reduce.py`` was missing
...
from vagus_fm.forward.duneuro_driver import build_conductivity_vector
...
def main(argv: list[str] | None = None) -> int:
    """``python -m vagus_fm.forward.reduce`` entry point."""
    import argparse
